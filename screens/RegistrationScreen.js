...
//         <Text style={styles.title}>Signup to TopDeck!</Text>
//       <KeyboardAvoidingView behavior='padding'>
//       <TextInput placeholder='First Name' value={firstName} onChangeText={text => setFirstName(text)} style={styles.inputContainer} />
//       <TextInput placeholder='Last Name' value={lastName} onChangeText={text => setLastName(text)} style={styles.inputContainer} />
//       <TextInput placeholder='Email' value={email} onChangeText={email => setEmail(email)} style={styles.inputContainer} />
