    ...
    async function fetchUserInfo() {
      ...
      if (
        ...
        if (
          userInformation &&
          userInformation.data() &&
          userInformation.data().first_name
        ) {
        ...
        Toast.show(
          "Unable to retrieve your information right now, please try again later",
          {
            duration: Toast.durations.LONG,
  ...
  return (
    ...
    >
      <Tab.Screen name={home} options={{ headerShown: false }}>
        {() => <LandingScreen userinfo={userinfo} />}
      </Tab.Screen>
      ...
      <Tab.Screen name={profilePage} options={{ headerShown: false }}>
