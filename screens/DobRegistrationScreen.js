      ...
      >
        <View style={styles.datePickerStyle}>
          <View style={styles.dateContainer}>
            ...
            >
              {formatDate(new Date(date_of_birth))}
            </Text>
          </View>
        ...
        {showDatePicker && (
          <RNDateTimePicker
            ...
            onChange={(event, dates) => {
              setDate_of_birth(dates.toISOString());
            }}
            maximumDate={
        ...
        <TouchableOpacity
          style={[styles.nxtBtn, { opacity: isValid ? 1 : 0.6 }]}
          onPress={() => {
            validate(true);
          }}
        >
          <Image
            source={require("../assets/images/purple-right-arrow.png")}
